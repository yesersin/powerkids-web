...
Future<ModelKullaniciUpdate?> kullaniciProfilResimUpdate({
  ...
  try {
    final postUri = Uri.parse(baseUrl + ServiceAdres().kullaniciUpProfilResim);
    ...
    if (data["success"].toString() != "1") {
      ...
      return ModelKullaniciUpdate.fromJson(data);
    }
  } catch (e) {
    debugPrint("kullaniciProfilResimUpdate big mistake:" + e.toString());
    hataMesaj = ("kullaniciProfilResimUpdate big mistake:" + e.toString());
    return null;
  }
}
