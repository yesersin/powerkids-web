...
Widget boy({required ModelOgrenciKarti kart}) {
  ...
  return yuvarlak(
      ...
      renk: Renk.kirmizi,
      komut: () {
        TextEditingController boy = TextEditingController(text: "80");
        TextEditingController kilo = TextEditingController(text: "30");
        Pencere().ac(
            content: Column(
              children: [
                ...
                Buton().mavi(
                    click: () async {
                      ...
                      if ((k < 6 || k > 40) || (b < 30 || b > 120)) {
                        toast(msg: "Kilo 6-40 arasında, boy 30-120 arasında olmalıdır.");
                        return;
                      }
