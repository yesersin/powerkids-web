...
class _OgrenciAileKartiState extends State<OgrenciAileKarti> {
  ...
  void initState() {
    ...
    widget.kart.data.aileFormu.ozelNot = "widget.kart.data.aileFormu.ozelNot";
    widget.kart.data.aileFormu.yemekEgitimi = "widget.kart.data.aileFormu.yemekEgitimi";
    widget.kart.data.aileFormu.alerjikDurumu = "widget.kart.data.aileFormu.alerjikDurumu";
    widget.kart.data.aileFormu.korkulari = "widget.kart.data.aileFormu.korkulari";
    widget.kart.data.aileFormu.tuvaletEgitimi = "widget.kart.data.aileFormu.tuvaletEgitimi";
    widget.kart.data.aileFormu.saglikDurumu = "widget.kart.data.aileFormu.saglikDurumu";
    widget.kart.data.aileFormu.aliskanliklari = "widget.kart.data.aileFormu.aliskanliklari";
  }
}
