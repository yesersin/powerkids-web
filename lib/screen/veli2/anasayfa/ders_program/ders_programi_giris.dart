...
import 'package:com.powerkidsx/screen/veli2/anasayfa/ders_program/widget/ders_program_list.dart';
import 'package:com.powerkidsx/screen/veli2/anasayfa/ders_program/widget/takvim.dart';
...
class _OgretmenDersProgramGirisState extends State<OgretmenDersProgramGiris> {
  ...
  void initState() {
    ...
    if (cp.okulAyarlar.data.dersProgrami == "haftalik") {
      widget.c.dersProgramServis = dersProgramOkulGetir(
