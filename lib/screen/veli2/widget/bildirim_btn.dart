    ...
    children: [
      IconButton(
          onPressed: () async {
            ...
            for (int i = 0; i < c.veliSayfalar.length; i++) {
              c.tempSayfalar.add(c.veliSayfalar[i]);
            }
            c.veliSayfalar.value =
                List.generate(c.veliSayfalar.length, (index) => BildirimGiris(c: c));
