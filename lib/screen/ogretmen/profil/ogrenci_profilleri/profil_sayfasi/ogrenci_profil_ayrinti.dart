...
import 'package:com.powerkidsx/screen/ogretmen/profil/ogrenci_profilleri/profil_sayfasi/widget/boy.dart';
import 'package:com.powerkidsx/screen/ogretmen/profil/ogrenci_profilleri/profil_sayfasi/widget/isim.dart';
import 'package:com.powerkidsx/screen/ogretmen/profil/ogrenci_profilleri/profil_sayfasi/widget/kilo.dart';
import 'package:com.powerkidsx/screen/ogretmen/profil/ogrenci_profilleri/profil_sayfasi/widget/ogrenci_aile_karti.dart';
import 'package:com.powerkidsx/screen/ogretmen/profil/ogrenci_profilleri/profil_sayfasi/widget/ogrenci_kisisel_bilgiler.dart';
import 'package:com.powerkidsx/screen/ogretmen/profil/ogrenci_profilleri/profil_sayfasi/widget/profil_foto.dart';
...
class OgretmenOgrenciProfilAyrinti extends StatefulWidget {
  COgretmen c;
  int index;
  RxList<Widget> rxSayfa;
  List<Widget> sayfa;

  OgretmenOgrenciProfilAyrinti(
      {Key? key,
      required this.c,
      required this.sayfa,
      required this.index,
      required this.rxSayfa})
      : super(key: key);
    ...
    return beyazCard(
      ...
      icerik: beyazCardAltMenu(
        ...
        komut: () {
          ...
          widget.rxSayfa[widget.index] = OgrenciAileKarti(
            c: widget.c,
            kart: kart!,
          );
        },
  ...
  Widget ogrenciBilgiler() {
    return beyazCard(
      ...
      icerik: beyazCardAltMenu(
          ...
          komut: () {
            widget.sayfa.add(OgrenciKisiselBilgiler(c: widget.c));
            widget.rxSayfa[widget.index] = OgrenciKisiselBilgiler(c: widget.c);
          }),
    );
  }
              ...
              child: Column(
                children: [
                  ...
                  beyazCardAltMenu(
                      ...
                      text: element.telefon,
                      komut: () {
                        telefonAra(element.telefon);
                      }),
                  SizedBox(width: 0, height: 10),
                  beyazCardAltMenu(
                    c: widget.c,
  ...
  Widget yoklamaGecmisi() {
    return beyazCard(
      ...
      icerik: beyazCardAltMenu(
        ...
        komut: () {
          widget.sayfa.add(OgretmenOgrenciYoklamaGecmis(kart: kart!));
          widget.rxSayfa[widget.index] = OgretmenOgrenciYoklamaGecmis(kart: kart!);
        },
      ),
    );
  }
  ...
  Widget etkinlikGecmisi() {
    return beyazCard(
      ...
      icerik: beyazCardAltMenu(
        ...
        komut: () {
          widget.sayfa.add(OgretmenOgrenciEtkinlikGecmis(kart: kart!));
          widget.rxSayfa[widget.index] = OgretmenOgrenciEtkinlikGecmis(kart: kart!);
        },
      ),
    );
  }
  ...
  Widget ilacKarti() {
    return beyazCard(
      ...
      icerik: beyazCardAltMenu(
        ...
        komut: () {
          widget.sayfa.add(OgretmenOgrenciIlacSaglik(kart: kart!));
          widget.rxSayfa[widget.index] = OgretmenOgrenciIlacSaglik(kart: kart!);
        },
      ),
    );
  }
