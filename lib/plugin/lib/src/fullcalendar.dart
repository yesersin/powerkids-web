...
class _FullCalendarState extends State<FullCalendar> {
  ...
  void initState() {
    setState(() {
      startDate =
          DateTime.parse("${widget.startDate.toString().split(" ").first} 00:00:00.000");
  ...
  Widget build(BuildContext context) {
    ...
    DateTime firstDate =
        DateTime.parse("${partsStart.first}-${partsStart[1].padLeft(2, '0')}-01 00:00:00.000");
                  ...
                  PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child:
                            month(daysOfMonth, width, widget.locale, widget.fullCalendarDay),
                      );
                    },
                  ),
                  Positioned(
  ...
  Widget dateInCalendar(DateTime date, bool outOfRange, double width, bool event) {
    bool isSelectedDate =
        date.toString().split(" ").first == widget.selectedDate.toString().split(" ").first;
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
                fontSize: 18.0, color: widget.dateColor, fontWeight: FontWeight.w400),
          ),
          Padding(
