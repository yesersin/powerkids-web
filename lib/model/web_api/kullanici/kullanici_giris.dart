...
//
//     final modelKullanici = modelKullaniciFromJson(jsonString);

import 'dart:convert';

ModelKullanici modelKullaniciFromJson(String str) => ModelKullanici.fromJson(json.decode(str));

String modelKullaniciToJson(ModelKullanici data) => json.encode(data.toJson());
...
class ModelKullanici {
  ...
  factory ModelKullanici.fromJson(Map<String, dynamic> json) => ModelKullanici(
        ...
        data: KullaniciData.fromJson(json["data"]),
        token: json["token"],
      );
...
class KullaniciData {
  ...
  factory KullaniciData.fromJson(Map<String, dynamic> json) => KullaniciData(
        id: json["_id"],
