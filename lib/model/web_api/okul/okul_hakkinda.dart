...
//
//     final modelOkulHakkinda = modelOkulHakkindaFromJson(jsonString);

import 'dart:convert';

ModelOkulHakkinda modelOkulHakkindaFromJson(String str) =>
    ModelOkulHakkinda.fromJson(json.decode(str));

String modelOkulHakkindaToJson(ModelOkulHakkinda data) => json.encode(data.toJson());

class ModelOkulHakkinda {
  ModelOkulHakkinda({
  ...
  factory ModelOkulHakkinda.fromJson(Map<String, dynamic> json) => ModelOkulHakkinda(
