...
//
//     final modelOgrenciIlacUpdateCevap = modelOgrenciIlacUpdateCevapFromJson(jsonString);

import 'dart:convert';

ModelOgrenciIlacUpdateCevap modelOgrenciIlacUpdateCevapFromJson(String str) =>
    ModelOgrenciIlacUpdateCevap.fromJson(json.decode(str));

String modelOgrenciIlacUpdateCevapToJson(ModelOgrenciIlacUpdateCevap data) =>
    json.encode(data.toJson());

class ModelOgrenciIlacUpdateCevap {
  ModelOgrenciIlacUpdateCevap({
  ...
  factory ModelOgrenciIlacUpdateCevap.fromJson(Map<String, dynamic> json) =>
      ModelOgrenciIlacUpdateCevap(
