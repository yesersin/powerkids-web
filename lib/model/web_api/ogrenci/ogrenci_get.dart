...
//
//     final modelOgrenciGet = modelOgrenciGetFromJson(jsonString);

import 'dart:convert';

import 'package:com.powerkidsx/model/web_api/sinif_ogrencileri.dart';

ModelOgrenciGet modelOgrenciGetFromJson(String str) =>
    ModelOgrenciGet.fromJson(json.decode(str));

String modelOgrenciGetToJson(ModelOgrenciGet data) => json.encode(data.toJson());

class ModelOgrenciGet {
  ModelOgrenciGet({
  ...
  factory ModelOgrenciGet.fromJson(Map<String, dynamic> json) => ModelOgrenciGet(
        success: json["success"],
        data: OgrenciGetData.fromJson(json["data"]),
      );
...
class OgrenciGetData {
  ...
  factory OgrenciGetData.fromJson(Map<String, dynamic> json) => OgrenciGetData(
        id: json["_id"],
        okulId: json["okulId"],
        arsiv: json["arsiv"],
  ...
  ModelOgrenci modelOgrenciDonustur() {
    return ModelOgrenci(
        id: id,
        okulId: okulId,
        arsiv: arsiv,
