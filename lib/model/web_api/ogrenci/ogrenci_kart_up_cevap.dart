...
//
//     final modelOgrenciKartUpCevap = modelOgrenciKartUpCevapFromJson(jsonString);

import 'dart:convert';

ModelOgrenciKartUpCevap modelOgrenciKartUpCevapFromJson(String str) =>
    ModelOgrenciKartUpCevap.fromJson(json.decode(str));

String modelOgrenciKartUpCevapToJson(ModelOgrenciKartUpCevap data) =>
    json.encode(data.toJson());

class ModelOgrenciKartUpCevap {
  ModelOgrenciKartUpCevap({
    required this.success,
    required this.data,
  });

  int success;
  KartUpCevapData data;

  factory ModelOgrenciKartUpCevap.fromJson(Map<String, dynamic> json) =>
      ModelOgrenciKartUpCevap(
        success: json["success"],
        data: KartUpCevapData.fromJson(json["data"]),
      );
...
class KartUpCevapData {
  ...
  factory KartUpCevapData.fromJson(Map<String, dynamic> json) => KartUpCevapData(
        id: json["_id"],
